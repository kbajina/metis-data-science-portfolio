...
## Initialize App
logo = Image.open("""/Users/kbajina/Documents/DATA SCIENCE/Metis | Data Science Bootcamp/Metis Project Portfolio/Metis-Proj-5/presentation_files/Walmart_logo_blue.png""")
...
directory = '/Users/kbajina/Documents/DATA SCIENCE/Metis | Data Science Bootcamp/Metis Project Portfolio/Metis-Proj-5'

## Train & Test DataFrames
pkl_file = open(directory + '/data_files/cluster_1_train.pkl', 'rb')
cluster_1_train = pickle.load(pkl_file)
pkl_file.close()

pkl_file = open(directory + '/data_files/cluster_1_test.pkl', 'rb')
cluster_1_test = pickle.load(pkl_file)
pkl_file.close()

pkl_file = open(directory + '/data_files/cluster_2_train.pkl', 'rb')
cluster_2_train = pickle.load(pkl_file)
pkl_file.close()

pkl_file = open(directory + '/data_files/cluster_2_test.pkl', 'rb')
...
pkl_file = open(directory + '/backup_files/test_holidays.pkl', 'rb')
test_holidays = pickle.load(pkl_file)
pkl_file.close()

pkl_file = open(directory + '/data_files/test_plus_future_holidays.pkl', 'rb')
test_plus_future_holidays = pickle.load(pkl_file)
pkl_file.close()

## Cluster 1 Model
pkl_file = open(directory + '/data_files/cluster_1_sarimax.pkl', 'rb')
clust1_model = pickle.load(pkl_file)
pkl_file.close()

## Cluster 2 Model 1
pkl_file = open(directory + '/data_files/cluster_2_sarimax_1.pkl', 'rb')
